...
# Preserve attribution in the exact upstream MIT PPTX template already published by UniPPT.
# Secret scans still apply to every archive member. Other author metadata remains rejected.
APPROVED_VENDOR_ARCHIVES = {'projects/UniPPT/vendor/pptx/src/templates/default.pptx': 'e10cc9e120961f6bd4074a373c9c80d2a06c497157e8f4972977b7bea83a8f34'}
        ...
        try:
            with zipfile.ZipFile(io.BytesIO(content)) as archive:
                ...
                for entry in entries:
                    ...
                    if entry.filename == "docProps/core.xml" and not name.startswith("vendor/") and APPROVED_VENDOR_ARCHIVES.get(name) != hashlib.sha256(content).hexdigest():
